...
import com.cristhian.SistemaInventario.Enums.EstadoStock;
...
public class ProductoDTO {
    ...
    public ProductoDTO(Producto producto){
        ...
        // Traemos el nombre de los nombres en el producto
        this.nombreCategoria = producto.getCategoria() != null
                ? producto.getCategoria().getNombreCategoria()
                : null;
        this.nombreMedida = producto.getUnidadMedida() != null
                ? producto.getUnidadMedida().getNombreMedida()
                : null;
        this.porcentaje = producto.getImpuesto() != null
                ? producto.getImpuesto().getPorcentaje()
                : null;
        this.nombre = producto.getProveedor() != null
                ? producto.getProveedor().getPersona().getNombre()
                : null;
        this.apellido = producto.getProveedor() != null
                ? producto.getProveedor().getPersona().getApellido()
                : null;
        this.segundoApellido = producto.getProveedor() != null
                ? producto.getProveedor().getPersona().getSegundoApellido()
                : null;
        this.razonSocial = producto.getProveedor() != null
                ? producto.getProveedor().getPersona().getRazonSocial()
                : null;
    }
